...
| A user-visible string, `t()`, a dictionary, a new language | `docs/languages.md` |
...
## User constraints — design and data

Keep the existing design during reviews and fixes. Do not change colors, typography, layout, or component styling.
Do not delete existing accounts or data during maintenance. Do not reset or rebuild databases.
Use tests without data deletion. Use a separate disposable database only after explicit user authorization.
