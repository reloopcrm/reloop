...
export const contactListInput = listInput.extend({
	...
	standing: standingFacetInput.default([]),
	potential: potentialFacetInput.default([]),
...
export const contactDraftOutput = z.object({
	subject: z.string(),
	body: z.string(),
...
export type ContactDraftState = z.infer<typeof contactDraftStateOutput>;

export const writeContactDraftInput = z.object({
	id: z.string(),
	instruction: z
		.string()
		.trim()
...
export const contactAttentionOutput = z.object({
	...
	reply: z.object({ email: z.string().nullable() }),
