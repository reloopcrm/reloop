		...
		kinds: {
			...
			deleted: {
				...
				lines: [
					...
					"Die Sicherungen auf unseren Servern werden nach {days} Tagen gelöscht.",
				],
			},
		},
	},
		...
		kinds: {
			...
			deleted: {
				...
				lines: [
					...
					"Las copias de seguridad en nuestros servidores se borran después de {days} días.",
				],
			},
		},
	},
		...
		kinds: {
			...
			deleted: {
				...
				lines: [
					...
					"Les sauvegardes sur nos serveurs sont supprimées après {days} jours.",
				],
			},
		},
	},
		...
		kinds: {
			...
			deleted: {
				...
				lines: [
					...
					"Os backups em nossos servidores são apagados depois de {days} dias.",
				],
			},
		},
	},
		...
		kinds: {
			...
			deleted: {
				...
				lines: [
					...
					"Sunucularımızdaki yedekler {days} gün sonra silinir.",
				],
			},
		},
	},
