...
function build(
	...
	return new MailboxSyncService(
		...
		provider as unknown as ImapSyncService,
		noConnections as unknown as GoogleConnectionService,
		noConnections as unknown as MicrosoftConnectionService,
		noConnections as unknown as ImapConnectionService,
		{ adoptRelevant: async () => 0 } as unknown as ThreadAdoptionService,
		{
			businessSetupRequested: async () => {
				asked.push("business-setup");
				return true;
			},
