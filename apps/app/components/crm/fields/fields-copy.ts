...
export const PROPOSED_GROUP = "Proposed by your agent";
export const PROPOSED_ACCEPTED = "Added to your fields.";
export const PROPOSED_DISMISSED = "Dismissed. It will not be proposed again.";
export const CAP_NOTE = "Full. Archive one to add another";
