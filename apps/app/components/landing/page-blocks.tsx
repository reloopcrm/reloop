...
export async function PricingActions({ secondary }: { secondary?: PageLink }) {
	const t = await getT();
...
export async function SelfHostNote() {
	const t = await getT();
	return (
